---
name: grill-me
description: Interview the user relentlessly about a plan or design until every branch of the decision tree has an explicit recorded decision and no open questions remain. Use when user wants to stress-test a plan, get grilled on their design, or mentions "grill me".
---
...
3. Ask exactly one question at a time. Choose the highest-leverage unresolved branch whose answer constrains the most downstream decisions, and include your recommended answer with the tradeoff that makes it preferable.
...
5. When no material open branches remain, return the complete decision record, assumptions, rejected alternatives that matter, risks, and explicit completion criteria. Do not end with another question.
